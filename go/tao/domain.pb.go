...
type TPMDetails struct {
	...
	// Path for AIK cert.
	AikCertPath      *string `protobuf:"bytes,4,opt,name=aik_cert_path" json:"aik_cert_path,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type TPM2Details struct {
	...
	Tpm2SealCert     *string `protobuf:"bytes,6,opt,name=tpm2_seal_cert" json:"tpm2_seal_cert,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
