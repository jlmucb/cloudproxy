 ...
 *  Description: create 32 bit PAE flat page tables for guest
 ...
 *     by one of the functions "fpt_create_32_bit_flat_page_tables" 
 *     or "fpt_create_64_bit_flat_page_tables"
 *  Input:
 ...
 *  Description: add new ranges with default attributes
 ...
 *  Description: This function is used in order to remove ranges from 
 *    existing mapping in flat page tables.
 *  Input:
 *        flat_page_table_handle - returned in creation
 *        src_addr - source address (GPA)
 *        size - size of the range
 ...
 *  Description: add "writable" permission to range
 *  Input:
 *        flat_page_table_handle - returned in creation
 *        src_addr - source address (GPA)
 *        size - size of the range
 ...
 *  Description: clear "writable" permission in range
 *
 *  Input:
 *        flat_page_table_handle - returned in creation
 *        src_addr - source address (GPA)
 ...
 *  Description: "executable" permission to range
 *  Input:
 *        flat_page_table_handle - returned in creation
 *        src_addr - source address (GPA)
 *        size - size of the range
 ...
 *  Description: clear "executable" permission in range
 ...
 *        src_addr - source address (GPA)
 *  Output:
 *        is_writable - on return TRUE, this BOOLEAN value indicates
 ...
 *  Description: returns the iterator, using which it is possible to iterate
 ...
 *  Description: returns the information about range from iterator.
 *  Input: flat_page_tables_handle  - handle returned upon creation;
 *         iter - iterator
 *  Output:
