...
typedef BOOLEAN (*IO_ACCESS_HANDLER)(GUEST_CPU_HANDLE gcpu,
                     UINT16  port_id, unsigned  port_size, // 1, 2, 4
                     RW_ACCESS access, BOOLEAN string_intr,  // ins/outs
...
// RETURNS  : status
VMM_STATUS io_vmexit_handler_register( GUEST_ID guest_id,
                IO_PORT_ID  port_id, IO_ACCESS_HANDLER handler,
                void *handler_context);
...
//          : IO_PORT_ID          port_id
// RETURNS  : status
VMM_STATUS io_vmexit_handler_unregister( GUEST_ID guest_id,
                IO_PORT_ID  port_id);
...
//          : IO_PORT_ID          port_to
// RETURNS  : void
void io_vmexit_block_port( GUEST_ID guest_id, IO_PORT_ID port_from,
                IO_PORT_ID  port_to);
