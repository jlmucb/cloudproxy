...
#               of a directory path.
#----------------------------------------------------------------------------
SOURCE     = guest.c guest_control.c guest_pci_configuration.c
ASM_SRC    =
...
INCLUDE_DIR   = . $(ROOT)/include $(ROOT)/include/hw $(ROOT)/../common/include
CFLAGS_DBG    =
CFLAGS_REL    =
LDFLAGS       =
LD_LIBDIR     =
...
OTHER_MAKEFILES  = ./scheduler/scheduler.mak ./guest_cpu/guest_cpu.mak
