//
//  File: hashprep.cpp 
//  Description: code measurment hashes
//
...
bool computeTPM12compositepcrDigest(byte pcrMask[3], byte* pcrs, byte* pcrDigest)
{
    ...
    revmemcpy(&composite[5], (u8*)&sizePCRs, sizeof(u32));
                     ...
                     u32 sizeversion, byte* versionInfo, byte* outputHash)
{
    ...
    revmemcpy(pb, (u8*)&tag, sizeof(u16));
    pb+= sizeof(u16);
    size+= sizeof(u16);
    ...
    revmemcpy(pb, (u8*)&selectSize, sizeof(u16));
    pb+= sizeof(u16);
    size+= sizeof(u16);
    ...
    revmemcpy(pb, (u8*)&loc, sizeof(byte));
    pb+= sizeof(byte);
    size+= sizeof(byte);
    ...
    if(addVer) {
        revmemcpy(pb, (u8*)&sizeversion, sizeof(u32));
        pb+= sizeof(u32);
        size+= sizeof(u32);
                     ...
                     int sizedigest, byte* digest, byte* outputHash)
{
    ...
    oHash.Init();
    oHash.Update(reinterpret_cast<const byte*>(szProlog), strlen(szProlog));
