...
int main(int argc, char** argv) {
    ...
    cloudproxy::FileClient fc(FLAGS_file_path,
                               FLAGS_client_cert,
                               FLAGS_client_key,
    ...
    CHECK(fc.Connect()) << "Could not connect to the server at "
    ...
    CHECK(fc.Authenticate("tmroeder", "./keys/tmroeder_pub_signed")) << "Could"
