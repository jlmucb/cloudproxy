...
#define IA32_MSR_FEATURE_CONTROL        (UINT32)0x03A
#define IA32_MSR_x2APIC_BASE            (UINT32)0x800
#define IA32_MSR_SYSENTER_CS            (UINT32)0x174
#define IA32_MSR_SYSENTER_ESP           (UINT32)0x175
#define IA32_MSR_SYSENTER_EIP           (UINT32)0x176
#define IA32_MSR_MISC_ENABLE            (UINT32)0x1A0

#define IA32_MSR_DEBUGCTL               (UINT32)0x1D9
...
#define IA32_MSR_PAT                    (UINT32)0x277

#define IA32_MSR_PERF_GLOBAL_CTRL       (UINT32)0x38F
...
#define IA32_MSR_PEBS_ENABLE            (UINT32)0x3F1
#define IA32_MSR_EFER                   (UINT32)0xC0000080
