...
DEBUG_CFLAGS:=  -Wall -Wextra -fwrapv -std=c99 -Wno-format -g -DDEBUG -D INVMM -D INCLUDE_LAYERING -nostartfiles -nostdlib  -fno-tree-loop-distribute-patterns -nodefaultlibs  -fno-tree-loop-distribute-patterns  -fPIE
RELEASE_CFLAGS:= -Wall -Wextra -fwrapv -std=c99 -Wno-unknown-pragmas -Wno-format -O3  -Wunused-function -D INVMM -D INCLUDE_LAYERING -nostartfiles -nostdlib  -fno-tree-loop-distribute-patterns -nodefaultlibs  -fno-tree-loop-distribute-patterns  -fPIE
