...
#               of a directory path.
#----------------------------------------------------------------------------
ASM_SRC    = em64t_interlocked.asm				\
			 em64t_isr.asm						\
			 em64t_utils.asm					\
			 em64t_gcpu_regs_save_restore.asm	\
			 em64t_vmx.asm						\
			 em64t_fpu.asm                      \
			 em64t_setjmp.asm
...
INCLUDE_DIR   = . $(ROOT)/include $(ROOT)/include/hw $(PROJS)/common/include
CFLAGS_DBG    =
CFLAGS_REL    =
LDFLAGS       =
LD_LIBDIR     =
...
em64t_gcpu_regs_save_restore.asm : $(PROJS)/common/include/ia32_registers.equ
