...
/* Function: hash64_change_size_and_rehash
 *  Description: change the size of the hash and rehash it.
 *  Input:
 *         hash_handle - handle returned by "hash64_create_hash" function
 ...
 *  Description: insert the value into 1-n hash.
 *  Input:
 *         hash_handle - handle returned by "hash64_create_multiple_values_hash" function
 *         key -
 *         value -
 ...
 *  Description: remove the value from 1-n hash.
 *  Input:
 ...
 *  Description: remove range of values from 1-n hash.
 *  Input:
 *         hash_handle - handle returned by "hash64_create_multiple_values_hash" function
 *         key -
