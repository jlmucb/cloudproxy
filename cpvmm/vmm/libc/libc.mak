...
#               of a directory path.
#----------------------------------------------------------------------------
SOURCE     = libc.c vmm_io.c vmm_serial.c common_libc.c sprintf.c bitarray_utilities.c

ifeq ($(TARGET_MACHINE_TYPE),x86)
	HW_DIR 	= ia32
	HW_COMMON_LIBC_DIR = ../../common/libc/$(HW_DIR)
	ASM_SRC = math.asm ia32_mem.asm
else
	HW_DIR 	= em64t
	HW_COMMON_LIBC_DIR = ../../common/libc/$(HW_DIR)
	ASM_SRC = em64t_mem.asm	
endif
...
INCLUDE_DIR   = $(ROOT)/include $(ROOT)/include/hw
CFLAGS_DBG    =
CFLAGS_REL    =
LDFLAGS       =
LD_LIBDIR     =
