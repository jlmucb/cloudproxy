...
RMM=        ../resources
CLM=	    ../claims
CFLAGS=     -D TPMSUPPORT -D TEST -D __FLUSHIO__ -D QUOTE2_DEFINED -D FAKESHA256
...
sobjs=      $(B)/tcIO.o $(B)/logging.o $(B)/jlmcrypto.o $(B)/jlmUtility.o \
	    ...
	    $(B)/tcService.o $(B)/hmacsha1.o $(B)/secPrincipal.o \
	    $(B)/channel.o $(B)/claims.o $(B)/trustedKeyNego.o $(B)/hashprep.o \
	    $(B)/encryptedblockIO.o
