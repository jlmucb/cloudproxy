...
parser.add_argument('policy_file', help='A text file of policy statements, one per line')
parser.add_argument('cert_id', type=int, help='The ordinal identifier of this certificate in the Policy namespace')
...
parser.add_argument('--crypt_utility', help='The path to cryptUtility.exe (default ./cryptUtility.exe)', default='./cryptUtility.exe')
parser.add_argument('--private_key', help='The path to the private key file to use to sign this policy (default policy/privatePolicyKey.xml)', default='policy/privatePolicyKey.xml')
...
create_policy(args.policy_file, args.cert_id, args.authority, args.crypt_utility, args.private_key, args.output)
