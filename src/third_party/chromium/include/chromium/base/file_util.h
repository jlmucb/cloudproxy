...
#ifndef CHROMIUM_BASE_FILE_UTIL_H_
#define CHROMIUM_BASE_FILE_UTIL_H_
...
// or -1 on error.
int AppendToFile(const FilePath& filename,
...
// Use only with extreme care.
bool CopyFileUnsafe(const FilePath& from_path,
                                const FilePath& to_path);
...
#endif  // CHROMIUM_BASE_FILE_UTIL_H_
