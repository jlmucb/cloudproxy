...
#               of a directory path.
#----------------------------------------------------------------------------
include $(PROJS)/common/evmm_cmpl_flag_option.mak

SOURCE     = copy_input_structs.c 					\
			 create_guests.c						\
			 layout_host_memory_for_mbr_loader.c	\
			 parse_pe_image.c						\
			 addons.c                               \
...
INCLUDE_DIR   = . $(ROOT)/include $(ROOT)/include/hw $(ROOT)/include/appliances
CFLAGS_DBG    +=
CFLAGS_REL    +=
LDFLAGS       =
LD_LIBDIR     =
