...
class Keys {
 public:
  ...
  /// @param policy A seal/unseal policy used to protect the secret keys.
  bool InitHosted(const TaoChildChannel &channel, int policy);
  ...
  /// Get the full Tao name of the public signing key.
