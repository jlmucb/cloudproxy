...
INLINE UINT32 vmcs_hw_make_compliant_pin_based_exec_ctrl( UINT32 value )
{
...
INLINE UINT32 vmcs_hw_make_compliant_processor_based_exec_ctrl( UINT32 value )
{
...
INLINE UINT32 vmcs_hw_make_compliant_processor_based_exec_ctrl2( UINT32 value )
{
...
INLINE UINT32 vmcs_hw_make_compliant_vm_exit_ctrl( UINT32 value )
{
...
INLINE UINT32 vmcs_hw_make_compliant_vm_entry_ctrl( UINT32 value )
{
...
INLINE UINT64 vmcs_hw_make_compliant_cr0( UINT64 value )
{
...
INLINE UINT64 vmcs_hw_make_compliant_cr4( UINT64 value )
{
...
INLINE UINT64 vmcs_hw_make_compliant_cr8( UINT64 value )
{
