...
// RETURNS  : void
void vmm_mem_free( char *file_name, INT32 line_number,
    IN void *buff);

void* vmm_mem_allocate_aligned( char *file_name,
...
// RETURNS  : UINT32 - size
UINT32 vmm_mem_buff_size( char *file_name,
      INT32 line_number, IN void *buff);
...
UINT32 vmm_mem_pool_size( char *file_name,
      INT32 line_number, IN UINT32 size);
