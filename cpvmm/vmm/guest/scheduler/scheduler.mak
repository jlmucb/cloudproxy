...
DEBUG_CFLAGS:=  -Wall -Wextra -Werror -fwrapv -std=c99 -Wno-format -g -DDEBUG -nostartfiles -nostdlib  -fno-tree-loop-distribute-patterns -nodefaultlibs -DJLMDEBUG -DINVMM
RELEASE_CFLAGS:= -Wall -Wextra -Werror -fwrapv -std=c99 -Wno-unknown-pragmas -Wno-format -nostartfiles -nostdlib  -fno-tree-loop-distribute-patterns -nodefaultlibs -DJLMDEBUG -DINVMM
